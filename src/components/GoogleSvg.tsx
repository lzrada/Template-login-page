    ...
    <div>
      <svg width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path
          fill-rule="evenodd"
          clip-rule="evenodd"
          d="M11.4999 22.9998C14.6049 22.9998 17.2081 21.9701 19.1108 20.2137L15.3943 17.3282C14.3645 18.0182 13.0472 18.426 11.4999 18.426C8.50471 18.426 5.96948 16.403 5.06516 13.6848H1.22311V16.6644C3.11539 20.4228 7.00448 22.9998 11.4999 22.9998Z"
          fill="#34A853"
        />
        <path
          fill-rule="evenodd"
        ...
        <path
          fill-rule="evenodd"
          clip-rule="evenodd"
          d="M11.4999 4.57386C13.1883 4.57386 14.7043 5.15409 15.8961 6.29364L19.1945 2.99523C17.2029 1.13955 14.5997 0 11.4999 0C7.00448 0 3.11539 2.57705 1.22311 6.33545L5.06516 9.315C5.96948 6.59682 8.50471 4.57386 11.4999 4.57386Z"
          fill="#EA4335"
        />
      </svg>
    </div>
